                    ...
                    //    console.log(arts[i])
                     ///   console.log("----------------------------------------")
                        out =  '<div class="grid-item">\n'+
                                ...
                                '                           <a class="md-btn md-btn--outline-primary" href="'+encodeURI("blog-detail.html?"+'contenturl='+arts[i].archtml+'&date='+arts[i].arctime+'&title='+arts[i].title+'&user='+arts[i].userid+'&arcid='+arts[i].arcid)+'">read more\n'+
                                '                           </a>\n'+
                                '                       </div>\n'+
                                '                   </div>\n'+
                                '                </div>\n'+
